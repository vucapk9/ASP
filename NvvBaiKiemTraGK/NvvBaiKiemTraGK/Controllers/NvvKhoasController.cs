...
using NvvBaiKiemTraGK.Models;

namespace NvvBaiKiemTraGK.Controllers
{
    public class NvvKhoasController : Controller
    {
        private NvvK22CNT2Lesson07DbEntities db = new NvvK22CNT2Lesson07DbEntities();
        ...
        public ActionResult Create([Bind(Include = "NvvMaKH,NvvTenKH,NvvTrangThai")] nvvKhoa nvvKhoa)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult NvvEdit([Bind(Include = "NvvMaKH,NvvTenKH,NvvTrangThai")] nvvKhoa nvvKhoa)
        {
            if (ModelState.IsValid)
            {
